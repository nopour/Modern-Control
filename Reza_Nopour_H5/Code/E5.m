...
legend('real','$q=0.1$','$q=1$','$q=10$','$q=100$','Interpreter','latex','Location','best') 
set(gca,'FontSize',12)
...
legend('$q=0.1$','$q=1$','$q=10$','$q=100$','Interpreter','latex','Location','best')
set(gca,'FontSize',12)
set(gca,'fontname','Times New Roman') 
grid on
grid minor
title('Controll Effort','Interpreter','latex')
xlabel('Time, [s]','Interpreter','latex')
